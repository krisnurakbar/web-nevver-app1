          ...
          <ul className="sidebar-menu" id="sidebar-menu">
            ...
            <li>
              <NavLink to="/text-generator" className={(navData) =>
                ...
                <Icon icon="tabler:message-chatbot" className="menu-icon" />
                <span>Text Generator</span>
              </NavLink>
            </li>
            
            <li className="sidebar-menu-group-title">System Utilities</li>
              ...
              <ul className="sidebar-submenu">
                <li>
                  <NavLink to="/users-list" className={(navData) =>
                    ...
                    <Icon icon="flowbite:users-group-solid" className="menu-icon" />
                    Users
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/roles-list" className={(navData) =>
                    navData.isActive ? "active-page" : ""
                  }>
                    <Icon icon="oui:app-users-roles" className="menu-icon" />
                    Roles
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/pages-list" className={(navData) =>
                    navData.isActive ? "active-page" : ""
                  }>
                    <Icon icon="subway:menu" className="menu-icon" />
                    Pages
                  </NavLink>
                </li>
              </ul>
            ...
            <li className="dropdown">
              <Link to="#">
                <Icon icon="mdi:service-toolbox" className="menu-icon" />
