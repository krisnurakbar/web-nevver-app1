...
import NevverHomePage from "./pages/NevverHomePage";
...
import HomeNevver from "./pages/HomeNevver";
...
function App() {
  ...
  return (
    <BrowserRouter>
      <RouteScrollToTop />
      <Routes>
        <Route exact path="/" element={isAuthenticated ? <HomeNevver /> : <SignInPage />} />

        <Route exact path="/admin" element={isAuthenticated ? <NevverHomePage /> : <SignInPage />} />
        ...
        <Route exact path="/pages-list" element={<PagesListPage />} />
        ...
        <Route exact path="/sign-in" element={isAuthenticated ? <NevverHomePage /> : <SignInPage />} />
        <Route exact path="/sign-up" element={isAuthenticated ? <NevverHomePage /> : <SignUpPage />} />
        ...
        <Route exact path="/text-generator" element={isAuthenticated ? <TextGeneratorPage />  : <SignInPage  />} />
        {/* <Route exact path="/text-generator/:id" element={isAuthenticated ? <TextGeneratorPage />  : <SignInPage  />} /> */}
